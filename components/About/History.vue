      ...
      <div class="container">
        <div class="max-w-[700px] mx-auto text-center fade-ani">
          ...
          <p class="hidden-el">
            ...
            customer service to our clients. In the many years of operation our
            staff compliment has hardly changed, showing the loyalty and
            dedication among our people, representing the ethos of our Company
            which spills through to the service we give our customers on a daily
            basis.
          </p>
